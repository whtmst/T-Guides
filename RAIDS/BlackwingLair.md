...
* **[Hourglass Sand](https://database.turtle-wow.org/?item=19183)**: Падает с трэша. Необходим для снятия **[Time Lapse](https://database.turtle-wow.org/?spell=23310)** (Bronze) на боссе **Chromaggus**.
...
* **1. Убийство Quartermaster:**
    ...
    * Убей **[Scarshield Quartermaster](https://database.turtle-wow.org/?npc=9046)**, чтобы получить **[Blackhand's Command](https://database.turtle-wow.org/?item=18987)**.

* **2. Выполнение квеста Blackhand's Command:**
    * Квест требует прикоснуться к **Orb of Ascension**, который находится за **[General Drakkisath](https://database.turtle-wow.org/?npc=10363)** (финальный босс UBRS).
...
* **[Bellowing Roar](https://database.turtle-wow.org/?spell=22686)** (Fear): Раз в 30 сек фир (страх). Жрецы вешают **Fear Ward**. Шаманы ставят **Tremor Totem**. Хилы и РДД могут прятаться и лосать (LoS) его.
