![COVER](img/MageConsumables.png)

# 🌿 **[T-Guides] Mage Consumables**

Полный список необходимой химии и расходников для мага, разбитый по специализациям.
...
| **[Juju Flurry](https://database.turtle-wow.org/?item=12450)** | Повышает скорость атаки и произнесения заклинаний на 3% на 20 сек. |
