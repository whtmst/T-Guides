...
> 💡 **О проекте:** Этот репозиторий содержит полезные ссылки, подробные тактики и гайды для рейдов и подземелий сервера **[Turtle WoW](https://turtlecraft.gg/)**.
...
* **[Turtle WoW Attunement Guide](https://forum.turtlecraft.gg/viewtopic.php?t=17691)** - гайд по всем аттюнам (доступам) классики и черепахи.
...
* **[TWoW Raid Visuals](https://github.com/MarcelineVQ/twow-raid-visuals)** - визуальное отображение AOE-зон боссов.
    * *Важно:* Использовать без HD-модов. Может конфликтовать со старыми HD-модами. Если любите HD-моды, то рекомендую использовать новые [модульные HD-моды](https://forum.turtlecraft.gg/viewtopic.php?t=21355).
* **[Модульные HD-моды](https://forum.turtlecraft.gg/viewtopic.php?t=21355)** - полностью рабочие HD-моды (включают в себя адаптированный и рабочий мод TWoW Raid Visuals).
...
Если гайды помогли тебе в рейде или упростили жизнь в Азероте, ты можешь отблагодарить автора: **[DALink](https://dalink.to/whtmst)**
