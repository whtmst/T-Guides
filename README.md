...
> 🚫 **ОСОБОЕ ПРИМЕЧАНИЕ:** На сервере Turtle WoW **все World Buffs (мировые баффы) автоматически отключаются** при входе в любое подземелье или рейд. Не тратьте время на их сбор!
